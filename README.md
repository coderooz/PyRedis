...
- **[DEVELOPERS_NOTES.md](DEVELOPERS_NOTES.md)** - Technical documentation for developers
- **[AGENTS.md](AGENTS.md)** - Project rules and governance
...
├── DEVELOPERS_NOTES.md      # Technical documentation
